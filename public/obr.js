...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('obr.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('obr.wasm', import.meta.url).href;
...
var ASM_CONSTS = {
  3623604: () => { return (typeof wasmOffsetConverter !== 'undefined'); }
};
...
function assignWasmExports(wasmExports) {
  _obr_init = Module['_obr_init'] = wasmExports['obr_init'];
  _obr_process = Module['_obr_process'] = wasmExports['obr_process'];
  _obr_set_rotation = Module['_obr_set_rotation'] = wasmExports['obr_set_rotation'];
  _obr_enable_head_tracking = Module['_obr_enable_head_tracking'] = wasmExports['obr_enable_head_tracking'];
  _obr_load_sofa = Module['_obr_load_sofa'] = wasmExports['obr_load_sofa'];
